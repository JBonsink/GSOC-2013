#include "ns3module.h"
static PyMethodDef imalse_FatalImpl_functions[] = {
    {NULL, NULL, 0, NULL}
};

static PyObject *
initimalse_FatalImpl(void)
{
    PyObject *m;
    m = Py_InitModule3((char *) "imalse.FatalImpl", imalse_FatalImpl_functions, NULL);
    if (m == NULL) {
        return NULL;
    }
    return m;
}
static PyMethodDef imalse_functions[] = {
    {NULL, NULL, 0, NULL}
};
/* --- classes --- */
...
static PyObject* _wrap_PyNs3ImalseHeader__get_m_data(PyNs3ImalseHeader *self, void * PYBINDGEN_UNUSED(closure))
{
    PyObject *py_retval;
    
    py_retval = Py_BuildValue((char *) "s#", (self->obj->m_data).c_str(), (self->obj->m_data).size());
    return py_retval;
}
static int _wrap_PyNs3ImalseHeader__set_m_data(PyNs3ImalseHeader *self, PyObject *value, void * PYBINDGEN_UNUSED(closure))
{
    PyObject *py_retval;
    ...
    self->obj->m_data = std::string(retval_ptr, retval_len);
    Py_DECREF(py_retval);
    return 0;
}
static PyGetSetDef PyNs3ImalseHeader__getsets[] = {
    {
        (char*) "m_data", /* attribute name */
        (getter) _wrap_PyNs3ImalseHeader__get_m_data, /* C function to get the attribute */
        (setter) _wrap_PyNs3ImalseHeader__set_m_data, /* C function to set the attribute */
...
static int
_wrap_PyNs3ImalseHeader__tp_init__0(PyNs3ImalseHeader *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    ...
    self->obj = new ns3::ImalseHeader();
    self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    return 0;
}

static int
_wrap_PyNs3ImalseHeader__tp_init__1(PyNs3ImalseHeader *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    PyNs3ImalseHeader *arg0;
    const char *keywords[] = {"arg0", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "O!", (char **) keywords, &PyNs3ImalseHeader_Type, &arg0)) {
        {
            PyObject *exc_type, *traceback;
            PyErr_Fetch(&exc_type, return_exception, &traceback);
            Py_XDECREF(exc_type);
    ...
    self->obj = new ns3::ImalseHeader(*((PyNs3ImalseHeader *) arg0)->obj);
    self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    return 0;
}

int _wrap_PyNs3ImalseHeader__tp_init(PyNs3ImalseHeader *self, PyObject *args, PyObject *kwargs)
{
    int retval;
    PyObject *error_list;
    PyObject *exceptions[2] = {0,};
    retval = _wrap_PyNs3ImalseHeader__tp_init__0(self, args, kwargs, &exceptions[0]);
    if (!exceptions[0]) {
        return retval;
    }
    retval = _wrap_PyNs3ImalseHeader__tp_init__1(self, args, kwargs, &exceptions[1]);
    if (!exceptions[1]) {
...
PyObject *
_wrap_PyNs3ImalseHeader_Deserialize(PyNs3ImalseHeader *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    uint32_t retval;
...
PyObject *
_wrap_PyNs3ImalseHeader_GetTypeId(void)
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
    
    ns3::TypeId retval = ns3::ImalseHeader::GetTypeId();
...
PyObject *
_wrap_PyNs3ImalseHeader_Serialize(PyNs3ImalseHeader *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyNs3BufferIterator *start;
    const char *keywords[] = {"start", NULL};
...
PyObject *
_wrap_PyNs3ImalseHeader_GetInstanceTypeId(PyNs3ImalseHeader *self)
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
...
PyObject *
_wrap_PyNs3ImalseHeader_GetSerializedSize(PyNs3ImalseHeader *self)
{
    PyObject *py_retval;
    uint32_t retval;
...
PyObject *
_wrap_PyNs3ImalseHeader_GetData(PyNs3ImalseHeader *self)
{
    PyObject *py_retval;
    std::string retval;
...
PyObject *
_wrap_PyNs3ImalseHeader_SetData(PyNs3ImalseHeader *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    const char *data;
    Py_ssize_t data_len;
    ...
    self->obj->SetData(std::string(data, data_len));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
static PyObject*
_wrap_PyNs3ImalseHeader__copy__(PyNs3ImalseHeader *self)
{

    PyNs3ImalseHeader *py_copy;
    py_copy = PyObject_GC_New(PyNs3ImalseHeader, &PyNs3ImalseHeader_Type);
    py_copy->obj = new ns3::ImalseHeader(*self->obj);
...
static PyMethodDef PyNs3ImalseHeader_methods[] = {
    {(char *) "Deserialize", (PyCFunction) _wrap_PyNs3ImalseHeader_Deserialize, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "GetTypeId", (PyCFunction) _wrap_PyNs3ImalseHeader_GetTypeId, METH_NOARGS|METH_STATIC, NULL },
    {(char *) "Serialize", (PyCFunction) _wrap_PyNs3ImalseHeader_Serialize, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "GetInstanceTypeId", (PyCFunction) _wrap_PyNs3ImalseHeader_GetInstanceTypeId, METH_NOARGS, NULL },
    {(char *) "GetSerializedSize", (PyCFunction) _wrap_PyNs3ImalseHeader_GetSerializedSize, METH_NOARGS, NULL },
    {(char *) "GetData", (PyCFunction) _wrap_PyNs3ImalseHeader_GetData, METH_NOARGS, NULL },
    {(char *) "SetData", (PyCFunction) _wrap_PyNs3ImalseHeader_SetData, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "__copy__", (PyCFunction) _wrap_PyNs3ImalseHeader__copy__, METH_NOARGS, NULL},
    {NULL, NULL, 0, NULL}
};

static void
PyNs3ImalseHeader__tp_clear(PyNs3ImalseHeader *self)
{
    Py_CLEAR(self->inst_dict);
        ns3::ImalseHeader *tmp = self->obj;
    self->obj = NULL;
...
static int
PyNs3ImalseHeader__tp_traverse(PyNs3ImalseHeader *self, visitproc visit, void *arg)
{
...
static void
_wrap_PyNs3ImalseHeader__tp_dealloc(PyNs3ImalseHeader *self)
{
    ...
    PyNs3ImalseHeader__tp_clear(self);
    self->ob_type->tp_free((PyObject*)self);
}

static PyObject*
_wrap_PyNs3ImalseHeader__tp_richcompare (PyNs3ImalseHeader *PYBINDGEN_UNUSED(self), PyNs3ImalseHeader *other, int opid)
{
    
    if (!PyObject_IsInstance((PyObject*) other, (PyObject*) &PyNs3ImalseHeader_Type)) {
...
PyTypeObject PyNs3ImalseHeader_Type = {
    PyObject_HEAD_INIT(NULL)
    0,                                 /* ob_size */
    (char *) "imalse.ImalseHeader",            /* tp_name */
    sizeof(PyNs3ImalseHeader),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_PyNs3ImalseHeader__tp_dealloc,        /* tp_dealloc */
    ...
    (traverseproc)PyNs3ImalseHeader__tp_traverse,     /* tp_traverse */
    (inquiry)PyNs3ImalseHeader__tp_clear,             /* tp_clear */
    (richcmpfunc)_wrap_PyNs3ImalseHeader__tp_richcompare,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)PyNs3ImalseHeader_methods, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    PyNs3ImalseHeader__getsets,                     /* tp_getset */
    NULL,                              /* tp_base */
    NULL,                              /* tp_dict */
    (descrgetfunc)NULL,    /* tp_descr_get */
    (descrsetfunc)NULL,    /* tp_descr_set */
    offsetof(PyNs3ImalseHeader, inst_dict),                 /* tp_dictoffset */
    (initproc)_wrap_PyNs3ImalseHeader__tp_init,             /* tp_init */
...
initimalse(void)
{
    PyObject *m;
    PyObject *submodule;
    m = Py_InitModule3((char *) "imalse", imalse_functions, NULL);
    if (m == NULL) {
        return;
    }
    ...
    /* Register the 'ns3::ImalseHeader' class */
    PyNs3ImalseHeader_Type.tp_base = &PyNs3Header_Type;
    if (PyType_Ready(&PyNs3ImalseHeader_Type)) {
        return;
    }
    PyModule_AddObject(m, (char *) "ImalseHeader", (PyObject *) &PyNs3ImalseHeader_Type);
    submodule = initimalse_FatalImpl();
    if (submodule == NULL) {
        return;
    }
    Py_INCREF(submodule);
